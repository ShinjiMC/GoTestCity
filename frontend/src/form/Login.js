  ...
  render() {
    return (
      <div className="has-text-centered">
        <p>
          Help GoCity{" "}
          <a href="https://github.com/ShinjiMC/GoTestCity">research</a> and let
          us know your opinion about <b>{this.props.projectURL}</b> design. You
          can{" "}
          <a href="#" onClick={this.props.onClose}>
            choose
          </a>{" "}
          another project to leave a comment.
        </p>
